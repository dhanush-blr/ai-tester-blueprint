...
**3. Documentation:** Finalize the **Maintenance Log** in `LLM.md` for long-term stability.
...
Before building any Tool, you must define the **Data Schema** in `LLM.md`.
...
`├── LLM.md          # Project Map & State Tracking ├── .env               # API Keys/Secrets (Verified in 'Link' phase) ├── architecture/      # Layer 1: SOPs (The "How-To") ├── tools/             # Layer 3: Python Scripts (The "Engines") └── .tmp/              # Temporary Workbench (Intermediates)`
